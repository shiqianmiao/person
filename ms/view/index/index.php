...
<header>
    <div class="container" style="padding:0px;">
        <div style="width:100%;height:70px;background-color:transparent;"></div>
            ...
            <div id="example5" class="slider-pro" style="padding-right: 277px; width: 100%; max-width: 835px;text-align:right;">
                <div class="sp-slides">
                    <div class="sp-slide" style="width: 670px; height: 500px;"><img class="sp-image" src="/images/blank.gif" data-src="/images/image1_medium.jpg" data-retina="/images/image1_large.jpg"/>
                        <div class="sp-caption">图片底部的描述内容</div>
                    </div>
                ...
                <div class="sp-thumbnails">
                    <div class="sp-thumbnail">
                        ...
                        <div class="sp-thumbnail-text">
                            <div class="sp-thumbnail-title">哦我我我我我哦哈哈哈哈哈我们大家好都嗯好</div>
                        </div>
                    </div>
                    <div class="sp-thumbnail">
                                ...
                                <div class="tab-pane nav bs-sidenav fade active in" id="sidebar-categories">
                                    <?php for ($i = 0 ; $i <= 7; $i++) {?>
                                        <li class="list-group-item <?php if ($i == 7) {?> last<?php }?>">
                                            <span class="post-title"><a href="http://www.yeahzan.com/zanblog/archives/763.html" title="Zanblog 2.0.7（稳定版）更新">uZanblog 2.0.7（稳定版）更新</a></span>
                                            <span class="badge"><i class="fa fa-comment"></i> <?php echo rand(1, 100);?></span>
                                            <span class="badge" data-toggle="tooltip" style="background-color:orange;" title="浏览量"><i class="fa fa-fw fa-eye"></i> <?php echo rand(1, 100);?></span>
                                        </li>
                                    <?php } ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                ...
                <div class="portfolio-caption">
                    <h4>WEB视频教程</h4>
                    <p class="text-muted">开启您的web入门之路吧！</p>
                </div>
            </div>

        ...
        <div style="width:900px;margin-left:50px;">
            ...
            <div class="box box-info">
                <div class="box-header">
                    <h3 class="box-title">匹配月嫂</h3>
                </div>
                <div class="box-body">
                    <div class="input-group input-group-sm" style="width:300px;">
                        <input name="parental_id" type="text" placeholder="输入要匹配的月嫂ID" class="form-control">
                ...
                <div class="box-footer">
                    ...
                    </font>个月嫂、当前已经匹配了<font style="color:red;"> <?php echo !empty($this->parental) ? count($this->parental) : 0;?> </font>个！
                </div><!-- /.box-footer-->
            </div>
...
G.use(['app/backend/js/backend.js', 'widget/dialog/dialog.js', 'jquery'], function (Backend, Dialog, $) {
    ...
    Backend.on('match', function (e) {
        ...
        var url = "/center/orderYuesao/iframeMatch?order_id="+orderId+"&id="+$.trim($('input[name="parental_id"]').val());

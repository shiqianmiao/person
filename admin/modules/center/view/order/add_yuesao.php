                    ...
                    <table class="table" style="border:none;">
                        <tbody>
                            ...
                            <tr>
                                <td style="border:none;">
                                    <div class="input-group ui-field">
                                        <span class="input-group-addon"><font style="color:red;"> * </font>上户时间：</span>
                            ...
                            <tr>
                                <td style="border:none;">
                                    <div class="input-group ui-field">
                                        <span class="input-group-addon"><font style="color:red;"> * </font>服务天数：</span>
                                        <input <?php if ($this->isEdit){?>disabled<?php }?> style="width:200px;" type="text" class="form-control" placeholder="服务天数" <?php echo $this->form->getField('service_day');?> >&nbsp;&nbsp;<span style="line-height: 35px;">天</span>
                                        <span class="checkinfo"><i class="i-infom"></i>
                                            <span id="service_day_tip"></span>
                                        </span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="border:none;">
                                    <div class="input-group ui-field">
                                        <span class="input-group-addon">生产医院：</span>
                                        <input <?php echo $this->form->getField('hospital');?> style="width:300px;" type="text" class="form-control">
                                        <span class="checkinfo"><i class="i-infom"></i>
                                            <span id="hospital_tip"></span>
                                        </span>
                                    </div>
                                </td>
                            </tr>
...
G.use(['app/backend/js/backend.js', 'jquery'], function (Backend, $) {
    ...
    Backend.on("submit", function(e) {
        ...
        form.validate().done(function() {
            ...
            $.ajax({
                url: "/center/orderYuesao/ajaxAddYuesaoOrder/",
                type: "POST",
                dataType: "json",
                data: {
                    ...
                    "service_day"   :  $.trim($('input[name="service_day"]').val()),
                ...
                success: function (result) {
                    if (result.errorCode) {
                        ...
                        window.setTimeout(function () {
                            location.href = "/center/orderYuesaoList/default/";
                        }, 3000);
                    }
                },
                error: function () {

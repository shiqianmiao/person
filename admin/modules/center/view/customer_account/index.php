            ...
            <div class="box-body">
                <div class="alert alert-info " style="padding:8px;margin:5px;">
                    <form method="get" action="#">
                        ...
                        客户手机：
                        <input type="text" value="<?php echo Request::getGET('mobile', ''); ?>" name="mobile" class="form-control" placeholder="筛选客户手机号" style="width:150px;display:inline-block">
...
G.use(['app/backend/js/backend.js', 'widget/dialog/dialog.js', 'jquery'], function (Backend, Dialog, $) {
    ...
    Backend.on('check_account', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
        var url = "/center/accountCus/checkAccount/?id="+id;
    ...
    Backend.on('edit', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
        var url = "/center/accountCus/iframeEdit/?id="+id;
        var dialog = new Dialog({
            title : '编辑账户信息',
            width : 500,
            height: 250,
    ...
    Backend.on('recharge', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
        var name = $(this).data('name');
        var mobile = $(this).data('mobile');
        var url = "/center/accountCus/iframeRecharge/?id="+id+"&name="+name+"&mobile="+mobile;
        var dialog = new Dialog({
            title : '账户充值',
            width : 800,
            height: 650,

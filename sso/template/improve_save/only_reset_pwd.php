...
<div id="head">
	...
	<div id="main">
    	<div id="password_modify5_2">
        	...
        	<form class="form1" method="post" name="resetPwdForm" action="/improveSave/onlyResetPwd/" autocomplete="off">
            <ul class="u1">
                <li class="clearfix">
    ...
    G.use(['jquery', 'app/v3/js/profile/profile.js'], function($, FormValidator){
        ...
        var $resetPwdForm = $('form[name=resetPwdForm]');
         if ($resetPwdForm.length == 1) {
             ...
             a.addCheckProject(['oldPasswd'], 'ajax', ['密码输入有误,请重新输入'], {url:'/profile/ajaxcheckpwd/', preTrue:true});
             a.checkSubmit();
         }
    });
</script>

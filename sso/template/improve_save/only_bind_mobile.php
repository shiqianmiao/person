...
<body>
<div id="head">
   	<h1><strong><a href="#"><img src="http://static.273.cn/app/v3/css/images/logo.gif" /></a></strong><span>绑定手机</span></h1>
</div>
    
	<div id="main">
    	<div id="only_bind_mobile">
            <form method="post" class="form1" name="bindMobileForm" action="/ImproveSave/onlyBindMobile/" autocomplete="off">
                <ul class="u1">

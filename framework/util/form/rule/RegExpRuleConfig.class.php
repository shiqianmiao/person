...
class RegExpRuleConfig {
    ...
    // 手机 + 电话
    const PHONE = '/^(1[3458]\d{9}|(?:(?:0\d{2,3}[- ]?[1-9]\d{6,7}))|(?:[48]00[- ]?[1-9]\d{6}))$/';
    
    //不包含手机号码
    const NO_PHONE = '/1[3458]\d{9}|(0\d{2,4}-)?[2-9]\d{6,7}(-\d{2,5})?|(?!\d+(-\d+){3,})[48]00(-?\d){7,10}/';
    ...
    //车牌号js
    const CAR_NUMBER = '/^[\u4e00-\u9fa5]{1}[A-Z]{1}[A-Z_0-9]{5}$/';
    //车牌号php
    const PHP_CAR_NUMBER = '/^[\x80-\xff]{3}[A-Z]{1}[A-Z_0-9]{5}$/';
}
